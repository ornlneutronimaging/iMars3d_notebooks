...
class Tilt(Parent):
    ...
    def calculate_tilt(self, index_0_degree, index_180_degree):
        ...
        self.parent.index_0_degree = index_0_degree
        self.parent.index_180_degree = index_180_degree
    ...
    def test_slices_selection(self):
        ...
        if self.parent.test_tilt_slices[0] is None:
            height, width = np.shape(self.parent.proj_norm)
            slice1 = 50
            slice2 = height - 50
        else:
        ...
        def plot_slices_to_reconstruct(slice1, slice2):
            ...
            ax.imshow(self.parent.proj_norm)
